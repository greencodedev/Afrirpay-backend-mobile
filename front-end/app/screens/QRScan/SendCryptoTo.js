...
const SendCryptoTo = () => {
  ...
  function renderNumbers() {
    return (
           ...
           <View style={{ flexDirection: 'row', justifyContent: 'space-between ', marginTop: SIZES.padding * 2, marginLeft: 23 }}>
            <Text style={{ fontSize: SIZES.font * 1.5, fontWeight: 'bold', color: "#A8A8A8" }}>
              Send to
            </Text>
            </View>
 ...
 <TouchableOpacity>
     <IconlyProvider
          ...
          <View style={styles.header}>
            <Text style={styles.headerText}>Crypto Transfer</Text>
            </View>
...
<View style={{
          ...
          <TouchableOpacity>
            <Text style={{ fontSize: 11, fontWeight: 'bold', color: "#374363" }}>
              Show All Contacts
            </Text>
          </TouchableOpacity>
        </View>
